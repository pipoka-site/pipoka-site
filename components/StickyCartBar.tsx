...
export default function StickyCartBar() {
  ...
  return <div className="fixed inset-x-0 bottom-0 z-40 border-t border-gold-400/20 bg-wine-900/95 text-white shadow-[0_-12px_35px_rgba(80,5,15,.25)] backdrop-blur md:hidden">
